...
export declare const CustomIconButton: import("styled-components").StyledComponent<import("../../components/Button/types").PolymorphicComponent<import("../../components/Button").BaseButtonProps, "button">, import("styled-components").DefaultTheme, {}, never>;
export declare const ModalCloseButton: React.FC<{
    headerTextColor?: ModalProps["headerTextColor"];
